...
export const width = (
  ...
  const iconNode = figma.createNodeFromSvg(
    ...
    <path d="M5.146 12.5H6.146L7.91162 6.125H7.97412L9.73975 12.5H10.7397L12.9272 4.5H11.9429L10.271 11.0156H10.1929L8.48975 4.5H7.396L5.69287 11.0156H5.61475L3.94287 4.5H2.9585L5.146 12.5Z" fill="#8C8C8C"/>
    </svg>`
  );
