  ...
  const renderStylePreview = () => {
    ...
    switch (type) {
      case "fill":
        ...
        } else if (error.paint && error.paint.type === "IMAGE") {
          return (
        ...
        } else if (error.paint && error.paint.type === "VIDEO") {
          return (
            <div className="style-preview">
              <img
                className="style-icon"
      ...
      case "text":
        return (
          <div className="style-preview text-preview">
            <span style={{ fontWeight: style.style?.fontStyle || "normal" }}>
              Ag
            </span>
          </div>
        );
